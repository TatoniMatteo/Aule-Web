...
/*!40000 ALTER TABLE `amministratore`
    DISABLE KEYS */;
INSERT INTO `amministratore`
VALUES (1, 'admin', 'adminpassword', 'admin@example.com', 0);
/*!40000 ALTER TABLE `amministratore`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `attrezzatura`
    DISABLE KEYS */;
INSERT INTO `attrezzatura`
VALUES (1, 'Proiettore', 'P12345', 1, 0),
       (2, 'Lavagna', 'L54321', 2, 0),
       (3, 'Computer', 'C67890', 3, 0),
       (4, 'Microfono', 'M45678', 1, 0);
/*!40000 ALTER TABLE `attrezzatura`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `aula`
    DISABLE KEYS */;
INSERT INTO `aula`
VALUES (1, 'Aula 101', 'Via Roma 1', 'Edificio A', 1, 50, 20, 10, NULL, 1, 0),
       (2, 'Aula 201', 'Via Roma 1', 'Edificio A', 2, 40, 15, 8, NULL, 2, 0),
       (3, 'Aula 301', 'Via Milano 2', 'Edificio B', 3, 30, 10, 6, NULL, 3, 0);
/*!40000 ALTER TABLE `aula`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `aula_gruppo`
    DISABLE KEYS */;
INSERT INTO `aula_gruppo`
VALUES (1, 1, 0),
       (1, 4, 0),
       (2, 2, 0),
       (2, 5, 0),
...
/*!40000 ALTER TABLE `corso`
    DISABLE KEYS */;
INSERT INTO `corso`
VALUES (1, 'Informatica', 'Corso di laurea in Informatica', 'Informatica', 0),
       (2, 'Economia', 'Corso di laurea in Economia', 'Scienze Economiche', 0),
       (3, 'Ingegneria', 'Corso di laurea in Ingegneria', 'Ingegneria', 0),
       (4, 'Lettere', 'Corso di laurea in Lettere', 'Lettere', 0);
/*!40000 ALTER TABLE `corso`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `evento`
    DISABLE KEYS */;
INSERT INTO `evento`
VALUES (1, NULL, 'Lezione 1', 'Prima lezione di Informatica', '2023-08-15', '09:00:00', '11:00:00', 1, 1, 1, 0,
        'Lezione'),
       (2, NULL, 'Seminario Finanza', 'Seminario sulla finanza aziendale', '2023-08-20', '14:00:00', '16:00:00', NULL,
        2, 2, 0, 'Seminario'),
       (3, NULL, 'Lab Elettronica', 'Laboratorio di elettronica', '2023-08-18', '10:00:00', '12:00:00', 3, 3, 3, 0,
        'Laboratorio'),
       (4, NULL, 'Conferenza Informatica', 'Conferenza su nuove tecnologie', '2023-08-25', '15:00:00', '18:00:00', NULL,
        4, 1, 0, 'Conferenza');
/*!40000 ALTER TABLE `evento`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `gruppo`
    DISABLE KEYS */;
INSERT INTO `gruppo`
VALUES (1, 'Informatica', 'Dipartimento di Informatica', 1, 0),
       (2, 'Economia', 'Dipartimento di Economia', 1, 0),
       (3, 'Ingegneria', 'Dipartimento di Ingegneria', 1, 0),
       (4, 'Scienze Umanistiche', 'Dipartimento di Scienze Umanistiche', 1, 0),
       (5, 'Polo Tecnologico', 'Polo di ricerca tecnologica', 2, 0),
       (6, 'Polo Culturale', 'Polo di ricerca culturale', 2, 0);
/*!40000 ALTER TABLE `gruppo`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `responsabile`
    DISABLE KEYS */;
INSERT INTO `responsabile`
VALUES (1, 'Mario', 'Rossi', 'mario.rossi@example.com', 0),
       (2, 'Laura', 'Bianchi', 'laura.bianchi@example.com', 0),
       (3, 'Luca', 'Verdi', 'luca.verdi@example.com', 0),
       (4, 'Anna', 'Gialli', 'anna.gialli@example.com', 0);
/*!40000 ALTER TABLE `responsabile`
    ENABLE KEYS */;
...
-- Dump completed on 2023-08-08 15:14:23
